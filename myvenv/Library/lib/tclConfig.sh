...
# installed.
TCL_PREFIX='K:/svm_iris_analysis/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='K:/svm_iris_analysis/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='K:/svm_iris_analysis/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IK:/svm_iris_analysis/myvenv\Library\include'
...
TCL_PACKAGE_PATH='K:/svm_iris_analysis/myvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LK:/svm_iris_analysis/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='K:/svm_iris_analysis/myvenv\Library\lib\tclstub86.lib'
